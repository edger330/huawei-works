...
time java \
-d64 -server -XX:+UseG1GC -XX:ParallelGCThreads=2 -Xms3g -Xmx30g -Djava.io.tmpdir=$tmp_dir -Djava.library.path=$lib_path -jar $gatk -T FastMuTect2 -R $reference_file -I:tumor $out_dir/NA12878MOD_sort_markdup_realign.bam -I:normal $out_dir/SRR098401_sort_markdup_realign.bam --dbsnp $dbsnp_del100 --cosmic $cosmic -contamination 0  --max_alt_alleles_in_normal_count 3 -cTable $out_dir/NA12878MOD_sort_markdup_realign.grp -nTable $out_dir/SRR098401_sort_markdup_realign.grp --max_alt_alleles_in_normal_qscore_sum 40 --max_alt_allele_in_normal_fraction 0.02 -dt NONE -o m2_wes_merged_mutect2_gatk4.vcf -nct 18 -dtt 25 -ntLib 36 --pair_hmm_implementation FPGA
